...
#define  RCC_PLLCFGR_PLLM_bit                ((uint32_t)0x00000000)
...
#define  RCC_PLLCFGR_PLLN_bit                 ((uint32_t)0x00000006)
...
#define  RCC_PLLCFGR_PLLP_bit                ((uint32_t)0x00000010)
...
#define  RCC_PLLCFGR_PLLQ_bit                ((uint32_t)0x00000018)
